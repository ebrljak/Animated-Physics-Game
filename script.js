...
window.addEventListener('load', function() {
    ...
    class Player {
        ...
        //context - to know which canvas we want to draw
        draw(context) {
            context.drawImage(this.image, this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, this.spriteWidth, this.spriteHeight, this.spriteX, this.spriteY, this.width, this.height);
            if(this.game.debug){
                context.beginPath();
                context.arc(this.collisionX, this.collisionY, this.collisionRadius, 0, Math.PI * 2);
            //to limit certain canvas settings only to specific draw calls we
            //can wrap that drawing code between save() and restore() methods

            //save() method creates a snapshot of the current canvas state
                context.save();
            //globalAlpha to set opacity of the shapes we are drawing
                context.globalAlpha = 0.5;
                context.fill();
                context.restore();
                context.stroke();
                context.beginPath();
            //moveTo() method will definestarting x and y coordinates of the line
                context.moveTo(this.collisionX, this.collisionY);
            //lineTo() methos will set the ending x and y coordinates of the line
        ...
        update() {
            ...
            else if (angle < 1.17) this.frame = 3;
    ...
    class Egg {
        ...
        update(deltaTime) {
            ...
            //spread operator allows us to quickly expand elements in an array insto another array
    ...
    class Game {
        ...
        canvas.addEventListener('mousedown', e => {
            //offsetX will give us horizontal coordinate of the click on the target node
